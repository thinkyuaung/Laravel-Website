...
Route::prefix('admin')->name('admin.')->middleware('auth')->group(function () {
   ...
   // Route::resource('social-media-links', SocialMediaLinkController::class);
    ...
    Route::get('payment_gateway_configs/getData', [PaymentGatewayConfig::class, 'getData'])->name('payment_gateway_configs.getData');
    Route::resource('payment_gateway_configs', PaymentGatewayConfig::class)->except(['show']);
